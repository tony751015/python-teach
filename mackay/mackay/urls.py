...
from user.views import user_fast_login, load_user_chat_room, chat_room_update_pin, chat_room_update_ban, update_user_lang
...
urlpatterns = [
    ...
    # User Profile & Lang API
    # path("api/user/profile", load_user_chat_room),
    path("api/user/update_lang", update_user_lang),
